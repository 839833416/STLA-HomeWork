...
4. Please write the results of the test set into column y of "classification_test.csv" and "regression_test.csv" files. The classification result is 0 or 1, and the regression prediction is a real number.

5. For evaluation, accuracy and mse (mean squared error) are used as performance metrics for classification and regression datasets respectively.